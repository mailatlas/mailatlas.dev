...
Use this page when your input already exists as files on disk. If you want MailAtlas to connect to a live mailbox, use [IMAP Receive](/docs/getting-started/manual-imap-sync/) instead.
...
- Use [IMAP Receive](/docs/getting-started/manual-imap-sync/) to fetch selected folders from a live mailbox.
