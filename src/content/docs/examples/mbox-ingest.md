...
An `mbox` file is not the same thing as IMAP receive. Use [IMAP Receive](/docs/getting-started/manual-imap-receive/) when MailAtlas should connect to a live mailbox and fetch selected folders.
